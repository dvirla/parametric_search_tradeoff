...
def setup_args():
    ...
    parser.add_argument("--query_template", type=str, default=None, choices=["plain", "natural", "query", "entity"], help="Override the dataset-based query-template routing (plain=passthrough, natural='answer in 2-4 sentences', query=structured Exact-Answer). For controlled template experiments.")
