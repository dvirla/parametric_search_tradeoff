...
def setup_args():
    ...
    parser.add_argument("--dataset", type=str, default="facts-search", choices=["facts-param", "facts-search", "nq", "entity-questions", "popqa", "sharechat", "musique-natural"], help="Dataset to evaluate on.")
...
def main():
    ...
    if args.dataset.lower() in ENTITY_STYLE_DATASETS or args.dataset.lower() == "sharechat":
