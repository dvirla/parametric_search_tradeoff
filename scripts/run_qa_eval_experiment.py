...
def setup_args():
    ...
    parser.add_argument("--dataset", type=str, default="facts-search", choices=["facts-param", "facts-search", "facts-open", "medqa", "nq", "entity-questions", "popqa", "sharechat", "sharechat-benchmark", "curated-sharechat", "curated-sharechat-benchmark", "musique-natural", "musique-natural2", "frames", "frames-benchmark", "frames-cues"], help="Dataset to evaluate on.")
