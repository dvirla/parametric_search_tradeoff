...
def setup_args():
    ...
    parser.add_argument("--dataset", type=str, default="facts-search", choices=["facts-param", "facts-search", "nq", "entity-questions", "popqa", "sharechat", "sharechat-benchmark", "musique-natural"], help="Dataset to evaluate on.")
